...
<body>
    ...
    <form class="form mx-auto my-5" method="POST">
        ...
        <p class="message">SignIn now and get full access to our website. </p>
        ...
        <div class="signin">
            <p>Forgot Password ? <a href="forgot_pass1.php">Click Here</a></p>
            <p>Don't have an acount ? <a href="regi1.php">SignUp</a></p>
        </div>
